...
### 株式会社 Belong(2022/07〜現在)

#### スマホ買取サービスの UI リブランディング (2022/07〜)

【プロジェクト概要】

UI の刷新、パートナー毎のテーマ切り替え
[プロダクトへのリンク](https://www.nicosuma.com/sell)

【規模、 役割】

4 名（フロント 3 名、 サーバサイド 1 名）。フロントエンドエンジニア。

【触れた技術】

TypeScript, Next.js, MUI,
Cypress, CircleCI, GCP

### 株式会社テイラーワークス（2021/01〜2022/03）
